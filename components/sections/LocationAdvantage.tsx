...
export default function LocationAdvantage() {
  ...
  const icons = [
    <Navigation className="w-5 h-5 text-river-600" key="0" />,
    <TrendingUp className="w-5 h-5 text-[#E05800]" key="1" />,
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              <MapPin className="w-3.5 h-3.5 text-[#E05800]" />
              ...
              return (
                <motion.div
                  ...
                  className={`p-8 rounded-2xl bg-white/95 border backdrop-blur-md transition-all duration-300 group cursor-pointer text-slate-900 ${
                    isHighlighted
                      ? "border-2 border-[#E05800] shadow-2xl shadow-[#E05800]/20"
                      : "border-white shadow-xl hover:border-[#E05800]/60 hover:shadow-2xl"
                  }`}
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <motion.div
                      ...
                      className="w-12 h-12 rounded-xl bg-slate-100 border border-slate-200 flex items-center justify-center group-hover:bg-[#E05800]/10 transition-colors"
                    >
                    ...
                    <span className="text-[11px] uppercase font-black tracking-wider px-3 py-1 rounded-full bg-[#E05800]/10 text-[#E05800] border border-[#E05800]/30">
                      {card.tag}
                    </span>
                  </div>

                  <h3 className="font-display text-xl font-extrabold text-slate-900 mb-3 group-hover:text-[#E05800] transition-colors">
                    {card.title}
                  </h3>
